...
GPH *create_graph(int vertices) {
    ...
    graph->adjacency_lists = malloc((vertices + 1) * sizeof(NODE *));//+1 pentru a incepe indexarea de la 1
    graph->visited = malloc((vertices + 1) * sizeof(int));//pentru a incepe nodurile de la 1
